...
class PopoverController{
  constructor($element, PositionService, $timeout, $scope){
    this.$el = $($element);
  ...
  activatePopover(){
    ...
    this.$timeout(()=>{
      ...
      $(document.body).on(`click.popoverbodyclicklistener${this.count}`, function(){
  ...
  positionElement(){
    this.positionService.positionElement(this.$el[0], this.$parent[0], this.above == 'true');
  }
